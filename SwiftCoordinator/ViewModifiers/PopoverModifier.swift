...
extension View {
    func popoverView<Item: Identifiable, Destination: View>(item: Binding<Item?>, destination: @escaping (Item) -> Destination) -> some View {
    modifier(PopoverModifier(item: item, content: destination))
  }
}
